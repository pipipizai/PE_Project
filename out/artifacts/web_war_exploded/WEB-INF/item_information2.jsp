...
//                where item.item_id=1 and item.user_id=U.user_id
                        ...
                        String item_information_sql ="select item_id, title, price, description, U.user_id, nickname\n" +
                                "from peproject.item, peproject.user as U\n" +
                                "where item.item_id= '"+ session.getAttribute("item_id")+"' and item.user_id=U.user_id";

                        ResultSet item_information_rs = item_information_stm.executeQuery(item_information_sql);
                        while(item_information_rs.next())
                        {
                    ...
                    <tr>
                        ...
                        <td height="40px" width="100px ">
                            <%=item_information_rs.getString("title")%>
                        </td>
                    </tr>
                    <tr>
                        <td width="150px" height="40px">Price</td>
                        <td height="40px" width="100px ">
                            <%=item_information_rs.getString("price")%>
                        </td>
                    </tr>
                    <tr>
                        <td width="150px" height="40px">Seller</td>
                        <td height="40px" width="100px ">
                            <%=item_information_rs.getString("nickname")%>
                        </td>
                    </tr>
                    <tr>
...
<div class="user_box" style="margin-top: 20px;margin-bottom: 500px">
    <ul>
        <li>
            ...
            <div class="user_item_tab_content" style="width: 100%" >
               <!--LOGO + Introduction -->
    <div>
...
//                where item_id=1 and comment.user_id=U.user_id
                ...
                String item_comment_sql ="select item_id, U.user_id, content, nickname\n" +
                        "from peproject.comment, peproject.user as U\n" +
                        "where item_id= '"+ session.getAttribute("item_id")+"' and comment.user_id=U.user_id";
            ...
            <div class="user_message_content" style="margin-top: 20px;width: 800px" >
                <div class="img_user_name" style="display: inline-block">
                    ...
                    <p style="color: #4A708B;font-family: Arial;font-size: 1.2em;font-weight: bold">
